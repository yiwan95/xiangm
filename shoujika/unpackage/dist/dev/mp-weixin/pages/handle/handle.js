...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var pickerAddress = function pickerAddress() {Promise.all(/*! require.ensure | city/city */[__webpack_require__.e("common/vendor"), __webpack_require__.e("city/city")]).then((function () {return resolve(__webpack_require__(/*! ../../city/city.vue */ 76));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  onLoad: function onLoad(val) {
    ...
    // this.date.recommend_image = this.date.recommend_image
    console.log(this.date.price);
    this.id = this.date.id;
    // this.price = options.price;
    // this.recommend_image = options.recommend_image
    // console.log('传过来的id值为：' + options.id + ',' + options.price + ',' + options.recommend_image);
  },
  methods: {
    ...
    submit: function submit() {
      ...
      // 		},
      // 		url: 'https://mobilecard.shenzhenbenwo.com/api/v2/index/createOrder/' + this.id,
      // 		method: 'POST',
      // 		data: {
      // 			'address': this.$refs.form.formData.cityTitle, //地址
      // 			'real_name': this.$refs.form.formData.name, //真实姓名
      // 			'ConsigneeName': this.$refs.form.formData.name, //收货人姓名
      // 			'phone': this.$refs.form.formData.mob, //电话
      // 			'idCard': this.$refs.form.formData.id_num, //身份证号码
      // 			'DetailedAddress': this.$refs.form.formData.add, //详细地址
      // 		},
      // 		dataType: 'json',
      // 		success: (res) => {
      ...
      // 			}
      // 			console.log(res.data.data.data.order_token)
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/handle/handle.js.map